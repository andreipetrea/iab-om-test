...
var module$exports$omid$common$version = {ApiVersion:"1.0", Version:"1.3.29-iab3282"};
...
var module$contents$omid$complianceVerificationScript$ComplianceVerificationClient_DefaultLogServer = "https://qa3-ads.corp.pinger.com/omsdk/sendmessage?", module$contents$omid$complianceVerificationScript$ComplianceVerificationClient_COMPLIANCE_VERIFICATION_CLIENT_VERSION = module$exports$omid$common$version.Version, module$contents$omid$complianceVerificationScript$ComplianceVerificationClient_AdEventTypeArray = [module$exports$omid$common$constants.AdEventType.IMPRESSION, module$exports$omid$common$constants.AdEventType.GEOMETRY_CHANGE, 
